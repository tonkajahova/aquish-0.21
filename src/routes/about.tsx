...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "AQUISH — ABOUT" },
      { name: "description", content: "AQUISH is an independent South African apparel label producing limited, considered drops designed and dispatched from our studio." },
      { property: "og:title", content: "AQUISH — ABOUT" },
      { property: "og:description", content: "Independent South African apparel. Limited drops, honest materials, built to last." },
      { property: "og:url", content: "https://instant-peek-engine.lovable.app/about" },
      { property: "og:type", content: "website" },
    ],
    links: [{ rel: "canonical", href: "https://instant-peek-engine.lovable.app/about" }],
  }),
  component: Page,
});
